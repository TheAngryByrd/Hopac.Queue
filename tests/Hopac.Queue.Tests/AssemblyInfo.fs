...
[<assembly: AssemblyTitleAttribute("Hopac.Queue.Tests")>]
[<assembly: AssemblyProductAttribute("Hopac.Queue")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Hopac.Queue.Tests"
    let [<Literal>] AssemblyProduct = "Hopac.Queue"
